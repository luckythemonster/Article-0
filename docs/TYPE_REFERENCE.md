...
`src/systems/EntityStats.ts:1386`
...
`src/systems/EntityStats.ts:1433`
...
`src/systems/EntityStats.ts:1661`
...
`src/systems/EntityStats.ts:1589`
...
`src/systems/EntityStats.ts:1465`
...
`src/scenes/game/SensingContext.ts:51`
...
| [CONSUMABLE_ORDER](#const-consumable-order) | const | `src/systems/EntityStats.ts:1386` |
| [ConsumableSlot](#interface-consumableslot) | interface | `src/systems/EntityStats.ts:1433` |
...
| [RelayStats](#interface-relaystats) | interface | `src/systems/EntityStats.ts:1661` |
...
| [SmacStats](#interface-smacstats) | interface | `src/systems/EntityStats.ts:1589` |
...
| [Vent4Stats](#interface-vent4stats) | interface | `src/systems/EntityStats.ts:1465` |
