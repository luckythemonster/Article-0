...
`src/systems/EntityStats.ts:449`
...
`src/systems/EntityStats.ts:524`
...
`src/systems/EntityStats.ts:575`
...
`src/systems/EntityStats.ts:515`
...
| [DoorStats](#interface-doorstats) | interface | `src/systems/EntityStats.ts:440` |
